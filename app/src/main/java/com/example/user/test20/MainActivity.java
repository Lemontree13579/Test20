...
import com.example.user.test20.R;
import com.example.user.test20.SearchActivity;
import com.example.user.test20.Words;
...
public class MainActivity extends AppCompatActivity {
    com.example.user.test20.WordsDBHelper mDbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDbHelper = new com.example.user.test20.WordsDBHelper(this);
